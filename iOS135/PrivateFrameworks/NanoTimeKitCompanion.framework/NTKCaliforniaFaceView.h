...
@property (nonatomic, retain) NTKCaliforniaColorEditOption *pride2020SensitiveShroudColor;
...
- (void)layoutSubviews;
- (id)pride2020SensitiveShroudColor;
...
- (void)setPride2020SensitiveShroudColor:(id)arg1;
