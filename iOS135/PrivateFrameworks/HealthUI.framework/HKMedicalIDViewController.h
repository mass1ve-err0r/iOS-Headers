...
@interface HKMedicalIDViewController : UITableViewController <HKEmergencyCardContactUpdateDelegate, HKEmergencyCardDeletionDelegate, HKEmergencyCardRowHeightChangeDelegate, HKEmergencyCardSelectionTableItemDelegate, HKMedicalIDViewControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
    bool  _allowsEditing;
