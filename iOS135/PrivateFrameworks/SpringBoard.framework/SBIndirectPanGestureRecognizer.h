...
@interface SBIndirectPanGestureRecognizer : UIGestureRecognizer <SBGestureRecognizerPanGestureProviding, SBGestureRecognizerTouchHistoryProviding, SBIndirectTouchLifecycleObserving> {
