...
+ (double)cscp_brightnessOfColor:(id)arg1;
+ (id)cscp_colorFromHexString:(id)arg1;
+ (id)cscp_hexStringFromColor:(id)arg1;
+ (id)cscp_hexStringFromColor:(id)arg1 alpha:(bool)arg2;
+ (bool)cscp_isColorLight:(id)arg1;
...
- (double)cscp_alpha;
- (double)cscp_blue;
- (double)cscp_brightness;
- (bool)cscp_dark;
- (double)cscp_green;
- (id)cscp_hexString;
- (id)cscp_hexStringWithAlpha;
- (double)cscp_hue;
- (bool)cscp_light;
- (double)cscp_red;
- (double)cscp_saturation;
- (bool)dark;
- (double)green;
- (id)hexString;
