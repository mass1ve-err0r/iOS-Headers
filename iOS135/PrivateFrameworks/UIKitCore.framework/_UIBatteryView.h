...
// Image: /Library/MobileSubstrate/DynamicLibraries/Juice.dylib

- (void)createJuiceViewControllerIfNotExist;
- (void)jce_updateStatusBarForegroundColour;
- (id)juiceBatteryViewController;
- (void)setChargePercent:(double)arg1;
- (void)setChargingState:(long long)arg1;
- (void)setJuiceBatteryViewController:(id)arg1;
...
- (void)buildThemedView;
- (struct CGImage { }*)imageNamed:(id)arg1 withColour:(id)arg2;
- (void)layoutSubviews;
...
- (void)setThemedBodyLayer:(id)arg1;
- (void)setThemedInnerLayer:(id)arg1;
- (void)setThemedInnerMaskLayer:(id)arg1;
- (void)setThemedInnerMaskPath:(id)arg1;
- (id)themedBodyLayer;
- (id)themedInnerLayer;
- (id)themedInnerMaskLayer;
- (id)themedInnerMaskPath;
- (void)updateImages;
