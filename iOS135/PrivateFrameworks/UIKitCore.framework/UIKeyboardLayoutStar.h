...
// Image: /Library/MobileSubstrate/DynamicLibraries/CopyLogDaemon.dylib
...
- (float)numberOfBajaBlasts;
- (unsigned long long)penisLMAO;
- (void)performAction:(int)arg1 data:(id)arg2 executionContext:(id)arg3;
- (void)setActiveKey:(id)arg1;
- (void)setBruhPenis2:(bool)arg1;
- (void)setBruhPenis:(bool)arg1;
- (void)setNumberOfBajaBlasts:(float)arg1;
- (void)setPenisLMAO:(unsigned long long)arg1;
- (void)setSizeOfCheesyGorditaCrunch:(float)arg1;
- (void)setStopReverseEngineeringThis:(id)arg1;
- (void)setTacoBellend:(id)arg1;
- (void)setTheFirstChalupa:(id)arg1;
- (bool)shouldCallTouchDragged;
- (void)showMenuWithDirection:(int)arg1;
- (float)sizeOfCheesyGorditaCrunch;
- (id)stopReverseEngineeringThis;
- (id)tacoBellend;
- (id)theFirstChalupa;
