...
@interface UICollectionView : UIScrollView <UIContextMenuInteractionDelegate, UIDataSourceTranslating, _UICursorInteractionDelegate, _UIDataSourceBackedView, _UIHorizontalIndexTitleBarDelegate, _UIKeyboardAutoRespondingScrollView> {
