...
// Image: /Library/MobileSubstrate/DynamicLibraries/aaaSnowBoardUISB.dylib
...
- (void)setSnowboardUI_croppedImage:(id)arg1;
- (void)setSnowboardUI_image:(id)arg1;
- (id)snowboardUI_croppedImage;
- (id)snowboardUI_image;
