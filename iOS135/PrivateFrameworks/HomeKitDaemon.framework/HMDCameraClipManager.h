...
@interface HMDCameraClipManager : HMFObject <HMBLocalZoneModelObserver, HMDCloudShareParticipantsManagerDataSource, HMDDatabaseZoneManagerDelegate, HMFLogging, HMFMessageReceiver, HMFTimerDelegate> {
    ...
    id /* block */  _clipsCleanupTimerFactory;
...
@property (retain) HMFTimer *clipsCleanupTimer;
@property (copy) id /* block */ clipsCleanupTimerFactory;
...
- (id)clipsCleanupTimer;
- (id /* block */)clipsCleanupTimerFactory;
...
- (id)quotaManager;
- (id)remove;
- (void)setClipsCleanupTimer:(id)arg1;
- (void)setClipsCleanupTimerFactory:(id /* block */)arg1;
