...
// Image: /Library/MobileSubstrate/DynamicLibraries/Chronos.dylib

+ (id)stringDateFormatter;
+ (id)stringDateFromDate:(id)arg1;
+ (id)stringDateFromString:(id)arg1;

// Image: /Library/MobileSubstrate/DynamicLibraries/Myriad.dylib

+ (id)stringDateFormatter;
+ (id)stringDateFromDate:(id)arg1;
+ (id)stringDateFromString:(id)arg1;

// Image: /Library/MobileSubstrate/DynamicLibraries/Weed.dylib

- (struct CGSize { double x1; double x2; })sizeOfStringWithFont:(id)arg1;
...
// Image: /usr/lib/libCSColorPicker.dylib

+ (double)_colorComponentFrom:(id)arg1 start:(unsigned long long)arg2 length:(unsigned long long)arg3;
+ (double)_cscp_colorComponentFrom:(id)arg1 start:(unsigned long long)arg2 length:(unsigned long long)arg3;
+ (id)colorFromHexString:(id)arg1;
+ (id)cscp_colorFromHexString:(id)arg1;
+ (bool)cscp_isValidHexString:(id)arg1;
+ (bool)isValidHexString:(id)arg1;

- (id)cscp_gradientStringCGColors;
- (id)cscp_gradientStringColors;
- (id)cscp_hexColor;
- (bool)cscp_validHex;
- (id)gradientStringCGColors;
- (id)gradientStringColors;
- (id)hexColor;
- (bool)validHex;
